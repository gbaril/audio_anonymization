...
def evaluate(parameters, f_eval, raw_sentences, parsed_sentences,
    ...
    tags = [t.split('-')[-1] for t in id_to_tag.values()]
    predictions = []
    ...
    #print(r_tags, p_tags)
    #print(e.evaluate(all_pred_tags, all_gold_tags, tags))
    score = e.evaluate(all_pred_tags, all_gold_tags, tags)
    tscore = e.evaluate(all_pred_tags, all_gold_tags, tags, e.info_label_transform)
