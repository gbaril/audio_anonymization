...
import os
from config import MFA_DIR
import shutil

def align_mfa(input_dir: str, output_dir: str):
    ...
    # Get directories
    dict_dir = os.path.join(MFA_DIR, 'pretrained_models/dictionary/french_prosodylab.dict')
    acoustic_dir = os.path.join(MFA_DIR, 'pretrained_models/acoustic/french_prosodylab.zip')
